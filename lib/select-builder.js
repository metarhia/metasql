...
class SelectBuilder extends QueryBuilder {
  ...
  where(key, cond, value) {
    this.whereConditions.and(key, cond, value);
    return this;
  }

  orWhere(key, cond, value) {
    this.whereConditions.or(key, cond, value);
    return this;
  }

  whereNot(key, cond, value) {
    this.whereConditions.not(key, cond, value);
    return this;
  }

  orWhereNot(key, cond, value) {
    this.whereConditions.orNot(key, cond, value);
    return this;
  }
  ...
  whereBetween(key, from, to, symmetric) {
    this.whereConditions.between(key, from, to, symmetric);
    return this;
  }

  orWhereBetween(key, from, to, symmetric) {
    this.whereConditions.orBetween(key, from, to, symmetric);
    return this;
  }

  whereNotBetween(key, from, to, symmetric) {
    this.whereConditions.notBetween(key, from, to, symmetric);
    return this;
  }

  orWhereNotBetween(key, from, to, symmetric) {
    this.whereConditions.orNotBetween(key, from, to, symmetric);
    return this;
  }

  whereIn(key, conds) {
    this.whereConditions.in(key, conds);
    return this;
  }

  orWhereIn(key, conds) {
    this.whereConditions.orIn(key, conds);
    return this;
  }

  whereNotIn(key, conds) {
    this.whereConditions.notIn(key, conds);
    return this;
  }

  orWhereNotIn(key, conds) {
    this.whereConditions.orNotIn(key, conds);
    return this;
  }

  whereAny(key, value) {
    this.whereConditions.any(key, value);
    return this;
  }

  orWhereAny(key, value) {
    this.whereConditions.orAny(key, value);
    return this;
  }

  whereExists(subquery) {
    this.whereConditions.exists(subquery);
    return this;
  }

  orWhereExists(subquery) {
    this.whereConditions.orExists(subquery);
    return this;
  }
